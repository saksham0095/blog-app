...
const feed=(props)=>{
    ...
    <div className="container">
      <div className="navbar-header">
        ...
        <a className="navbar-brand" href="#">Blog Name</a>
      </div>
      <div id="navbar" className="navbar-collapse collapse">
        ...
        <ul className="nav navbar-nav navbar-right">
          ...
          <li className="active"><a href="./">Static top <span class="sr-only">(current)</span></a></li>
    ...
    <span className="input-group-btn">
      <button className="btn btn-default" type="button">Go!</button>
              ...
              <div className="list-group">
                  <a className="list-group-item active" href="#"> <h4 class="list-group-item-heading">List group item heading</h4> <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p> </a>
                  <a className="list-group-item" href="#"> <h4 className="list-group-item-heading">List group item heading</h4> <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p> </a>
                  <a className="list-group-item" href="#"> <h4 className="list-group-item-heading">List group item heading</h4> <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p> </a> </div>
              {/* <div className="well">
                  <div className="media"> <div className="media-left"> <a href="#"> <img data-src="holder.js/64x64" className="media-object" alt="64x64" style="width: 64px; height: 64px;" src="data:image/svg+xml;base64," data-holder-rendered="true"> </img></a> </div> <div class="media-body"> <h4 class="media-heading">Media heading</h4> Cras sit amet nibh libero, in gravida nulla.</div> </div>
                  <div className="media"> <div className="media-left"> <a href="#"> <img data-src="holder.js/64x64" className="media-object" alt="64x64" style="width: 64px; height: 64px;" src="data:image/svg+xml;base64," data-holder-rendered="true"> </img></a> </div> <div class="media-body"> <h4 class="media-heading">Media heading</h4> Cras sit amet nibh libero, in gravida nulla.</div> </div>
                  <div className="media"> <div className="media-left"> <a href="#"> <img data-src="holder.js/64x64" className="media-object" alt="64x64" style="width: 64px; height: 64px;" src="data:image/svg+xml;base64," data-holder-rendered="true"> </img></a> </div> <div class="media-body"> <h4 class="media-heading">Media heading</h4> Cras sit amet nibh libero, in gravida nulla.</div> </div>
              </div> */}
          </div>
...
<section className="footer-link"><a href="http://bootsnipp.com/grafreez" target="_blank">View Our All Snnips</a></section>
</div>);
};
